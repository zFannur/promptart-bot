...
from utils.menu import CREATE_VIDEO_LABELS, USER_TEXT
...
@router.message(GenStates.waiting_for_video_prompt, USER_TEXT)
...
async def _do_video_generation(
    *,
    ...
    try:
        ...
        logger.exception("unexpected video failure: {}", e)
        await progress_msg.edit_text(t(i18n, "video.error"))
        return
